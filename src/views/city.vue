<template>
 ...
 <div class="section intro" id="intro" >
  <transition enter-active-class="animated bounceInDown" leave-active-class="animated zoomOutRight">
        <div v-show="btn">
            <div class="container">
                <div class="row">
...
.intro{
  background: url("../assets/images/city-bg.jpg") no-repeat fixed top center/ cover;
}
</style>
